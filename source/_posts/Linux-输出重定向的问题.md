...
本文中涉及的 `Shell` 脚本已经被我上传至 `GitHub`，读者可以提前下载查看：[test_redirect相关脚本](https://github.com/iplaypi/iplaypistudy/tree/master/iplaypistudy-normal/src/bin/20170504) ，脚本命名与下文中描述一致。
...
4、本文中涉及的 `Shell` 脚本已经被我上传至 `GitHub`，读者可以下载查看：[test_redirect相关脚本](https://github.com/iplaypi/iplaypistudy/tree/master/iplaypistudy-normal/src/bin/20170504) ，脚本命名与上文中描述一致。
