...
`Jekyll` 配合 `GitHub Pages` 搭建博客，里面提到了可以使用 `Docker` 安装 `Jekyll` 环境，方便快捷。那么，对于 `Hexo` 环境来说，是否存在通过 `Docker` 来安装的方法呢？【待寻找】
...
在博客站点的左下角添加宠物挂件，我选择了一只猫，并且它会根据光标的位置来回看，希望能给看我博客的读者带去一点好心情。参考我的博客内容：[给博客站点增加一个可以交互的挂件](https://www.playpi.org/2017031801.html) 。
