...
本文中涉及的 `c` 语言脚本已经被我上传至 `GitHub`，读者可以提前下载查看：[signal 相关脚本](https://github.com/iplaypi/iplaypistudy/tree/master/iplaypistudy-normal/src/bin/20190421) ，脚本命名与下文中描述一致。
